 ...
 * 20-Apr-2015
 */
public class CPapers extends javax.swing.JFrame {
    ...
    private void ordBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ordBtnActionPerformed
        CPapersOrdinary myOrdinary = new CPapersOrdinary();
        myOrdinary.setVisible(true);
        dispose();
    ...
    private void highBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_highBtnActionPerformed
        CPapersHigher myHigher = new CPapersHigher();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CPapers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
